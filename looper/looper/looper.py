...
@Configuration.option('analysis', 'enable_vfg', type=click.BOOL, is_flag=True, help="Enable variable flow graph extension.")
@Configuration.option('analysis', 'enable_rc',  type=click.BOOL, is_flag=True, help="Enable reset chain extension.")
